export const T = {
  ...
  admin: {
    ...
    home: { es: "Pantalla principal", en: "Home layout" },
    history: { es: "Historial", en: "History" },
    search: { es: "Buscar proyectos", en: "Search projects" },
    published: { es: "Publicado", en: "Published" },
    draft: { es: "Borrador", en: "Draft" },
    preview: { es: "Vista previa", en: "Preview" },
    unsaved: { es: "Cambios sin guardar", en: "Unsaved changes" },
    autosave: { es: "Guardado automático", en: "Autosave" },
