...
export default function Contact() {
  ...
  return (
    <div data-testid="contact-page" className="bg-white pt-32 md:pt-40 pb-32">
      <div className="px-6 md:px-12 lg:px-16">
        <p className="text-[11px] tracking-[0.32em] uppercase text-neutral-500 mb-6">
          {tr(T.contact.title, lang)}
        </p>
        <p className="text-2xl md:text-4xl lg:text-5xl tracking-tight font-light leading-[1.1] max-w-4xl text-neutral-800">
        ...
        <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
          <div className="md:col-span-7">
            ...
            <a
              ...
              className="text-2xl md:text-4xl lg:text-5xl tracking-tight font-light hover:opacity-60 transition break-words inline-block"
            >
              {s.email}
            </a>
          </div>
            ...
            <div className="flex flex-col gap-3">
              {links.map((l) => (
                <a
                  ...
                  className="group inline-flex items-center justify-between border-b border-black/10 py-3 hover:border-black transition"
                >
                  <span className="text-base">{l.label}</span>
                  <ArrowUpRight className="w-4 h-4 opacity-40 group-hover:opacity-100 group-hover:translate-x-1 transition" strokeWidth={1.5} />
                </a>
              ))}
            </div>
          </div>
